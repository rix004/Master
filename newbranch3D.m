function [nodes] = newbranch3D(levels,x_val,y_val,z_val,lev,edges,r_vect,x1,y1,z1,theta,phi,distance,root_radius,r_rate,d_rate,delta_theta,delta_phi)
    if levels ~= 1
        ...
        rightside = newbranch3D(levels-1,x,y,z,l,e,r,x2,y2,z2,theta+delta_theta*(0.5 + 1*rand()),phi+delta_phi,distance*d_rate,root_radius*r_rate,r_rate,d_rate,delta_theta,90*rand());
