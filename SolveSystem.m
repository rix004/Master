function[p_darcy,q_darcy,q_network,p_network]=SolveSystem(nodes,edges,MicroTN,TermNodes,Dir_network,Neu_network,mu,k,K_N,LHS,RHS,cell_area,BC)
Ne = length(edges);
Nn = length(nodes);
